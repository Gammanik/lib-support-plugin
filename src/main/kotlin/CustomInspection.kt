...
class CustomInspection : AbstractBaseJavaLocalInspectionTool() {
    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean): PsiElementVisitor {
        return object : JavaElementVisitor() {
            ...
            private val DESCRIPTION_TEMPLATE =
                "SDK " + InspectionsBundle.message("inspection.comparing.references.problem.descriptor")
             ...
             * @return      `true` if input is `PsiClassType` and matches
    ...
    private class CriQuickFix : LocalQuickFix {
        ...
        override fun applyFix(
            ...
            try {
                ...
                val equalsCall =
                    factory.createExpressionFromText("a.equals(b)", null) as PsiMethodCallExpression
                ...
                if (opSign === JavaTokenType.NE) {
                    val negation =
                        factory.createExpressionFromText("!a", null) as PsiPrefixExpression
    ...
    companion object {
        ...
        val QUICK_FIX_NAME =
            "SDK: " + InspectionsBundle.message("inspection.comparing.references.use.quickfix")
    }
}